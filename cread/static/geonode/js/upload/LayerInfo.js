...
/* This file is copied and modified form the original LayerInfo.js */
...
define(function (require, exports) {
    ...
    LayerInfo.prototype.displayUploadedLayerLinks = function(resp) {
        ...
        var b = '<a href="' + resp.url + '/cread_metadata_create" class="btn btn-warning">' + gettext('Next: Edit Metadata') + '</a>';
        ...
        self.logStatus({
            msg: '<p>' + gettext('Your layer was successfully uploaded') + '<br/>'
                + msg_col + '<br/>'
                + b + '&nbsp;&nbsp;&nbsp;',
            level: 'alert-success',
            empty: 'true'
        });
        $("#cread-upload-button-panel").hide();
        /*self.logStatus({
            msg: '<p>' + gettext('Your layer was successfully uploaded') + '<br/>'
                + msg_col + '<br/>'
                + a + '&nbsp;&nbsp;&nbsp;'
